...
export const  adminList=data => Http.post('/admin/login',data);

export const  adminCount=data => Http.post('/admin/login',data);

export const shopList=data => Http.post('/admin/login',data);
/*
显示所有客服*/
export const  getadminSetList=data => Http.get('/admin/staffs',data);

export const upload=data => Http.post('/image_server/upload',data,'code');

export const  add_staff=data => Http.post('/admin/add_staff',data);

export const  update_staff=data => Http.post('/admin/update_staff',data);

// 提现申请
export const  withdraw=data => Http.get('/admin/withdraw',data);

export const serach=data=> Http.get('/admin/search_withdraw',data);

export const serachquestion=data=> Http.get('/admin/cycle_new_question',data);


export const  serachOldQuition=data=> Http.get('/admin/cycle_old_question',data);

export const  serachOldQuitiones=data=> Http.get('/admin/cycle_service_question',data);

export const  searchTj=data=> Http.get('/admin/question/search',data);

export const  update_question=data=> Http.post('/admin/update_question',data);

export const  add_answer=data=> Http.post('/admin/add_answer',data);

export const  withdrawPost=data => Http.post('/admin/withdraw',data);

export const  onlineGet=data => Http.get('/admin/online',data);
export const  onlinePost=data => Http.post('/admin/online',data);
