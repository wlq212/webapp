      ...
      switch (this.payName) {
        ...
        case "支付宝":
          ...
          if(result1.error_no==0){
            if(that.isWeiXin()){
              window.location.href="http://web.5dcfo.com/html5Order1/index.html?pay_type=alipay"+"&body="+that.name.product_name+"&price="+that.productInfo.price+"&order_id="+that.productInfo.order_id;
            }else{
